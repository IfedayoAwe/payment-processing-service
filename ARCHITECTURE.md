...
### 6. Simple but Realistic Provider Abstraction
...
### 11. Service Layer Encapsulation

Services expose only methods, not fields. Handlers interact with services through interfaces, not direct database access.

**Why:** Encapsulation prevents handlers from bypassing business logic. Service interfaces enable testing with mocks and make dependencies explicit.
